                    ...
                    <li>
                        ...
                        <ul class="bank_account_details">
                            ...
                            <li class="details_item ">
                                <a class="some_btn" style="height: 40px; line-height: 3;" href="<?= base_url('my_account/disable_bank_account') ?>">Désactiver</a><!-- my_account doubled if present  / absent if removed -->
                                <a class="some_btn" style="height: 40px; line-height: 3;" href="<?= base_url('my_account/add_bank_account/'.$bank_account_data->Id) ?>">Remplacer</a>
                            </li>
                        </ul>
                    </li>
                <?php else: ?>
